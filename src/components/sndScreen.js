...
function App() {
    ...
    if (userAccountt != '' && userAccountt != null) {
        ...
        connectBtn = <Link to={{ pathname: '/WhichWallet' }}><button style={{ color: 'white', padding: '3px 17px' }}>Connect Wallet</button></Link>
    }
                            ...
                            <div className="blueBlackMainDiv3">
                                ...
                                <div className="greyDiv2Desktop">
                                    <div className="row">
                                        ...
                                        <div className="col-8">
                                            <h5 className="pdfheading" style={{ fontSize: '18px' }}>How to install a Digital Wallet</h5>
                                            <p className="pdfPara" style={{ fontSize: '12px' }}>Learn how to install Metamask Wallet</p>
                                        </div>
                                        <div className="col-2">
                                ...
                                <div className="greyDiv2Desktop">
                                    <div className="row">
                                        ...
                                        <div className="col-8">
                                            <h5 className="pdfheading" style={{ fontSize: '18px' }}>How to acquire FTP tokens</h5>
                                            <p className="pdfPara" style={{ fontSize: '12px' }}>Learn vaious way to acquire FTP</p>
                                        </div>
                                        <div className="col-2">
                                            <img src={pdfdropdown} alt="pdfdropdown" />
                                        </div>
                                ...
                                <div className="greyDiv2Desktop">
                                    <div className="row">
                                        ...
                                        <div className="col-8">
                                            <h5 className="pdfheading" style={{ fontSize: '18px' }}>How to Stake FTP tokens</h5>
                                            <p className="pdfPara" style={{ fontSize: '11px' }}>What is Staking and how to Stake FTP</p>
                                        </div>
                                        <div className="col-2">
                                            <img src={pdfdropdown} alt="pdfdropdown" />
                                        </div>
                    ...
                    <div className="blueBlackMainDiv2">
                        ...
                        <div className="greyDiv2">
                            <div className="row">
                                ...
                                <div className="col-8">
                                    <h5 className="pdfheading">How to install a Digital Wallet</h5>
                                    <p className="pdfPara">Learn how to install Metamask Wallet</p>
                                </div>
                                <div className="col-2">
                                    <img src={pdfdropdown} alt="pdfdropdown" />
                                </div>
                        ...
                        <div className="greyDiv2">
                            <div className="row">
                                ...
                                <div className="col-8">
                                    <h5 className="pdfheading">How to acquire FTP tokens</h5>
                                    <p className="pdfPara">Learn vaious way to acquire FTP</p>
                                </div>
                                <div className="col-2">
                                    <img src={pdfdropdown} alt="pdfdropdown" />
                                </div>
                        ...
                        <div className="greyDiv2">
                            <div className="row">
                                ...
                                <div className="col-8">
                                    <h5 className="pdfheading">How to Stake FTP tokens</h5>
                                    <p className="pdfPara">What is Staking and how to Stake FTP</p>
                                </div>
                                <div className="col-2">
                                    <img src={pdfdropdown} alt="pdfdropdown" />
                                </div>
