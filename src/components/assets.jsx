...
function App() {
  ...
  const [USDTPriceOfBFTP, setUSDTPriceOfBFTP] = useState('0');
  ...
  async function useEffectFunc() {
    ...
    axios.get('https://deep-index.moralis.io/api/v2/erc20/0x18C85Fa24491Ddc01e216Ddb806AC17C212356Bb/price?chain=bsc',
      ...
      .then(res => {
        console.log('BFTP price in usdt', res.data.usdPrice);
        // setUSDTPriceOfBNB(res.data.usdPrice)
  ...
  let bftpInUsd = (Number(FairtraderBlnc).toFixed(4)) * process.env.REACT_APP_FTP_MANUALLY_PRICE;
  ...
  if (stakedBalance === 0.0000 || stakedBalance === '0.0000' || stakedBalance === '') {
                  ...
                  <div className="greyDiv2DeskAssets" style={{ paddingTop: '10px', paddingBottom: '5px', overflow: 'hidden', backgroundColor: 'black' }}>
                    <div className="row">
                      ...
                      <div className="col-3">
                        <h5 className='pdfheading' style={{ marginTop: '3px', fontWeight: 'bold', textAlign: 'end' }}>
                          <span style={{ marginRight: '5px', position: 'relative', left: '-18px' }}>$</span>
                          <span style={{ position: 'relative', left: '-17px' }}>{bftpInUsd.toFixed(0)} </span>
                        </h5>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-3">
                      ...
                      <h5 className='pdfheading assetsValueHeading' style={{ marginTop: '3px', fontWeight: 'bold', textAlign: 'start' }}>
                        ...
                        <span style={{ position: 'relative', left: '-12px', fontSize: '16px' }}>{bftpInUsd.toFixed(0)} </span>
                      </h5>
                    </div>
                  </div>
