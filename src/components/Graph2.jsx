...
import { historyOptions } from "../chartConfigs/chartConfigs2";
  ...
  return (
    <>
      <div className='bottomHeader'>
        ...
        {/* <div className='row graphTopHeader'>
          <div className="col-6">
        ...
        <p className="text-right graphPeriods">
      ...
      {/* <div className='graph' style={{ width: '90%', maxWidth: '90%', minWidth: '90%' }}>
