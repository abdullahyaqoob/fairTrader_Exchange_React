...
class App extends Component {
  ...
  render() {
    ...
    if (this.state.loading === false) {
      StakeBtnDesktop =
        <p style={{ textAlign: 'center' }}>
          <button className='stakeBtnss'
            style={{ backgroundColor: '#2223DE', marginTop: '5px' }}
            onClick={(event) => {
              if (this.inputA.value === '' || this.inputA.value === null || this.inputA.value === undefined || this.inputA.value === '0' || this.inputA.value === 0 || this.inputA.value >= window.web3.utils.fromWei(this.state.tokenBalance, 'Ether')) {
                alert('Invalid Stake Amount')
              } else {
                event.preventDefault()
                let etherAmountA = this.inputA.value.toString()
                setTimeout(() => {
                  // console.log('etherAmountA', etherAmountA);
                }, 1000);
                // let notFormatedAmount = etherAmount
      ...
      StakeBtnDesktop = <button className='amountStakeBtns' style={{ backgroundColor: '#2223DE' }}>Loading...</button>
    }
    ...
    let paramsDataContent = <h4 className='colorGreyy' style={{ marginBottom: '0px', color: '#39393B' }}>Balance: {window.web3.utils.fromWei(this.state.tokenBalance, 'Ether')}</h4>


    let ratePerAnnum
    let StakePeriodRate = localStorage.getItem('StakePeriod')
    if (StakePeriodRate === '24 Months') {
      ratePerAnnum = '24 Months @ 15% Per Year'
    } else if (StakePeriodRate === '12 Months') {
      ratePerAnnum = '12 Months @ 10% Per Year'
    } else {
      ratePerAnnum = '06 Months @ 07% Per Year'
    }
      ...
      <div style={{ backgroundColor: 'black' }}>
                          ...
                          <h5 style={{ color: '#0367FE' }}><input
                            ...
                            onChange={(event) => {
                              ...
                              if (localStorage.getItem('StakePeriod') === '24 Months') {
                                setTimeout(() => {
                                  let extraStakeAmountt = ((tokenAmountA / 100) * 15) * 2
                                ...
                                setTimeout(() => {
                                  let extraStakeAmountt = (tokenAmountA / 100) * 10
                                  console.log('7777777777777', extraStakeAmountt.toString().length);
                                  let extraStakeAmount
                                  if (extraStakeAmountt.toString().length > 10) {
                                    extraStakeAmount = extraStakeAmountt.toFixed(5)
                                ...
                                setTimeout(() => {
                                  let extraStakeAmountt = ((tokenAmountA / 100) * 7) / 2
                                  console.log('7777777777777', extraStakeAmountt.toString().length);
                                  let extraStakeAmount
                                  if (extraStakeAmountt.toString().length > 10) {
                                    extraStakeAmount = extraStakeAmountt.toFixed(5)
        ...
        <div className='MainDivMob'>
          ...
          <div className="blueDiv">
            ...
            <div>
              <div className="bottomHeaderrr" style={{ paddingTop: '6px' }}>
                <div className="row" style={{ marginBottom: '-6px' }}>
                  ...
                  <div className="col-6">
                    ...
                    <p style={{ color: 'black', fontSize: '20px', textAlign: 'center', fontWeight: 'bold', marginTop: '5px' }}>Stake<span style={{ color: '#91D8F7', fontSize: '12px' }}>_</span>FTP?</p>
                  </div>
                  <div className="col-2">
                ...
                <div className='DeskContentDiv' style={{ paddingLeft: '20px', paddingRight: '20px' }}>
                  ...
                  <br />
                  <h4 className='colorGreyy' style={{ color: '#39393B', marginTop: '-10px', marginBottom: '-8px' }}>
                    unlock date: {dateOfUnlock}
                  </h4>
                  <br />
                  <p style={{ textAlign: 'center', color: '#1dccff', fontSize: '18px', marginTop: '-5px' }}>
                    {StakeBtn}
                  </p>
                </div>
              </div>
