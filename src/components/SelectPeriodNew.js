            ...
            <div className="col-4">
              ...
              <div className="bottomHeaderr functionalityDiv">
                ...
                <div style={{ backgroundColor: '#91d8f7', borderBottomLeftRadius: '20px', borderBottomRightRadius: '20px' }}>
                  <hr className='hr' style={{ marginBottom: '-12px' }} />
                  ...
                  <div style={{ width: '90%', margin: '0 auto', marginBottom: '-20px' }}>
                    <p className='headingOfNewPeriodSelct'>
                      Note this special offer applies to newly swapped tokens only. The tokens will be locked against early sale for period selected.
                    </p>
                  </div>

                  <div className="networksDivvDesktop " style={{ marginBottom: '0px', backgroundColor: 'black' }}>
                    <h4 onClick={() => handleSelectSwapToken('06 Months')}>
                      06 Months @ 20% Per Year</h4>
                    <hr className='selectPeriodHR' />
                    <h4 onClick={() => handleSelectSwapToken('12 Months')}>
                      {/* <span style={{ color: 'gold' }}>12 Months</span> @ 25% Per Year</h4> */}
                      <span>12 Months</span> @ 35% Per Year</h4>
                    <hr className='selectPeriodHR' />
                    <h4 onClick={() => handleSelectSwapToken('24 Months')}>
                      24 Months @ 50% Per Year</h4>
                  </div>
                  <br /><br />
                </div>
                {/* <hr className='hr selctNewPeriodHR' style={{ marginTop: "21px" }} />
                <div className="row selctNewPeriodROW" style={{ marginBottom: '23px', marginTop: '15px' }}>
                  <div className="col-6">
                    {assetsTxt}
                  </div>
                  <div className="col-6">
        ...
        <div className="blueDiv">
          <div className="MainLinks">
            <div className='row'>
              ...
              <div className='mainLinksPics col-3'>
                <Link to={{ pathname: '/StakePage' }}><img className='mainLinksPics2' style={{ marginTop: '2px' }} src={stakeImg} alt="stakeImg" /></Link>
              </div>
              <div className='mainLinksPics col-3'>
                <a target="_blank" href="https://latoken.com/exchange/FTP_USDT "><img style={{ marginTop: '1px' }} className='mainLinksPics2' src={tradeImg} alt="tradeImg" /></a>
              </div>
            </div>
          </div>
          <div>
            <div className="bottomHeaderrr" style={{ paddingTop: '5px' }}>
              ...
              <div style={{ backgroundColor: '#91d8f7', borderBottomLeftRadius: '20px', borderBottomRightRadius: '20px' }}>
                ...
                <br />
                <br />
                <div style={{ width: '90%', margin: '0 auto', marginBottom: '-20px', marginTop: '-28px' }}>
                  <p className='selctPeriodNewTxt' style={{ textAlign: 'start', fontSize: '14px', color: 'black', fontWeight: 'bold', fontFamily: "arial" }}>
                    Note this special offer applies to newly swapped tokens only. The tokens will be locked against early sale for period selected.
                  </p>
                </div>

                <div className="networksDivv" style={{ backgroundColor: 'black', marginTop: '35px', paddingTop: '20px', paddingBottom: '20px' }}>
                  <h4 onClick={() => handleSelectSwapToken('06 Months')}>
                    06 Months @ 20% Per Annum</h4>
                  <hr className='selectPeriodHR' />
                  <h4 onClick={() => handleSelectSwapToken('12 Months')}>
                    <span>12 Months</span> @ 35% Per Annum</h4>
                  <hr className='selectPeriodHR' />
                  <h4 onClick={() => handleSelectSwapToken('24 Months')}>
                    24 Months @ 50% Per Annum</h4>
                </div>
